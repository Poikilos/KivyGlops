...
class KivyGlopsWindow(ContainerForm):  # formerly a subclass of Widget
    ...
    def __init__(self, **kwargs):
        ...
        self.inventory_prev_button = Factory.Button(text="<", size_hint=(.2,1.0), on_press=self.inventory_prev_button_press)
        self.use_button = Factory.Button(text="0: Empty", size_hint=(.2,1.0), on_press=self.inventory_use_button_press)
        self.inventory_next_button = Factory.Button(text=">", size_hint=(.2,1.0), on_press=self.inventory_next_button_press)
