...
void main(void)
{
	...
	alpha_spec_correction(tmp83.rgb, cons91, unf92, tmp93);
	shade_add(tmp89, tmp83, tmp96);
	mtex_alpha_to_col(tmp96, tmp93, tmp99);
	shade_mist_factor(varposition, unf101, unf102, unf103, unf104, unf105, tmp106);
	mix_blend(tmp106, tmp99, unf109, tmp110);
	mtex_alpha_to_col(tmp110, tmp93, tmp113);
	output_node(tmp113, tmp93, tmp116);
	linearrgb_to_srgb(tmp116, tmp118);
