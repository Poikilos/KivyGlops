...
uniform vec4 unf67;
const float cons73 = float(1.000000);
uniform float unf76;
uniform float unf77;
uniform float unf78;
uniform float unf79;
...
void main(void)
{
	...
	shade_add(tmp68, tmp62, tmp71);
	mtex_alpha_to_col(tmp71, cons73, tmp74);
	shade_mist_factor(varposition, unf76, unf77, unf78, unf79, unf80, tmp81);
	mix_blend(tmp81, tmp74, unf84, tmp85);
	shade_alpha_opaque(tmp85, tmp87);
	linearrgb_to_srgb(tmp87, tmp89);
