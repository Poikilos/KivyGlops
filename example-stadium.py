...
class MainScene(KivyGlops):
    ...
    def on_load_glops(self):
        ...
        carpeted_cement_hit_light1 = os.path.join(
            "sounds",
            "carpeted-cement-hit,light1.wav"
        )
        carpeted_cement_hit1 = os.path.join(
            "sounds",
            "carpeted-cement-hit1.wav"
        )
        carpeted_cement_hit2 = os.path.join(
            "sounds",
            "carpeted-cement-hit2.wav"
        )
        for index in self.get_indices_of_similar_names("rock"):
            ...
            self.add_bump_sound_at(index, carpeted_cement_hit_light1)
            self.add_bump_sound_at(index, carpeted_cement_hit1)
            self.add_bump_sound_at(index, carpeted_cement_hit2)
        ...
        chimp_info['land_units_per_second'] = \
            self.glops[player1_index].actor_dict['land_units_per_second'] / 2.
